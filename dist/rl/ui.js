...
const BANDIT_INTRO = {
  greedy: '現在もっとも推定報酬 Q(a) が高いアームだけを選び続けます。ランダムな探索は行わないため、最初の数回で偶然よい結果が出たアームに偏り、本当はもっと良いアームを見逃すことがあります。',
...
const BANDIT_READING = {
  greedy: 'Greedyは現在もっとも良さそうなアームだけを選びます。そのため、初期の偶然によって評価が低くなったアームは、その後ほとんど試されません。「確率をシャッフル」して何度か実行し、ε-GreedyやUCBと結果を比較してみましょう。',
